...
angle_HWP           = 0.05 * pi / 180;
angle_QWP           = 50 * pi / 180;
angle_parasitic_WP  = 0 * pi / 180;
retard_parasitic_WP = 0 * pi / 180;
lambda_0            = 800e-9;
...
[t, E]              = arbitraryWP_PAC(t, E, angle_parasitic_WP, retard_parasitic_WP);
...
subplot 224
    ...
    grid on
    drawnow
    sgtitle(['Simulation for ', hwpType, ' and ', qwpType, ' waveplates'], 'interpreter', 'none')
